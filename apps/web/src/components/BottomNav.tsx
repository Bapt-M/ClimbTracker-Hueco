...
const navColors = {
  explore: { active: '#08D9D6', bg: 'rgba(8, 217, 214, 0.15)' },      // blue
  leaderboard: { active: '#FFD700', bg: 'rgba(255, 215, 0, 0.15)' },  // yellow
  profile: { active: '#FF2E63', bg: 'rgba(255, 46, 99, 0.15)' },      // pink
  friends: { active: '#9B59B6', bg: 'rgba(155, 89, 182, 0.15)' },     // purple
  analytics: { active: '#2ECC71', bg: 'rgba(46, 204, 113, 0.15)' },   // green
};
  ...
  return (
    <div className="fixed bottom-0 z-50 w-full max-w-md bg-white border-t-4 border-climb-dark pb-8 pt-4 shadow-[0_-8px_20px_rgba(0,0,0,0.05)]">
      <div className="grid grid-cols-5 h-12 px-2">
        ...
        {/* Profile - Bouton central surélevé */}
        <Link
          to={profilePath}
